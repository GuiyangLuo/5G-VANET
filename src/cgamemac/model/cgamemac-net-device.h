...
#ifndef CGAMEMAC_NET_DEVICE_H
#define CGAMEMAC_NET_DEVICE_H
 ...
 * \ingroup cgamemac
 *
 * This class holds together ns3::WifiChannel, ns3::WifiPhy, and CgamemacMac.
 */
class CgamemacNetDevice: public ns3::WifiNetDevice {
public:
	static ns3::TypeId GetTypeId(void);

	CgamemacNetDevice();
	virtual ~CgamemacNetDevice();

	void SetMac(ns3::Ptr<CgamemacMac> mac);
	void SetPhy(ns3::Ptr<ns3::WifiPhy> phy);
	void SetRemoteStationManager(
			ns3::Ptr<ns3::WifiRemoteStationManager> manager);
	ns3::Ptr<CgamemacMac> GetMac(void) const;
	...
	virtual bool Send(ns3::Ptr<ns3::Packet> packet, const ns3::Address& dest,
	...
	virtual bool SendFrom(ns3::Ptr<ns3::Packet> packet,
	...
	void
	SetGraphUpLoadCallback(
			ns3::Callback<void, ns3::Ptr<cgame::GraphUpLoad> > upcallack);
	void
	SendtoMacLayer(ns3::Ptr<cgame::cgameDownload> download);
...
private:
	...
	void ForwardUp(ns3::Ptr<ns3::Packet> packet, ns3::Mac48Address from,
			ns3::Mac48Address to);
	void LinkUp(void);
	void LinkDown(void);
	void Setup(void);
