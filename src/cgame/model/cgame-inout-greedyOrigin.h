#ifndef CGAME_INOUT_GREEDY_ORIGIN_H
#define CGAME_INOUT_GREEDY_ORIGIN_H
#include <fstream>
...
class cgameinoutgreedyOrigin: public ns3::Object {
public:
	static ns3::TypeId
	GetTypeId(void);
	cgameinoutgreedyOrigin();
	cgameinoutgreedyOrigin(double comRangeRsu, double comRangeObu,
