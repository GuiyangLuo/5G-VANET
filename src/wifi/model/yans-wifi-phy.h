...
public:
	...
	void StartReceivePacket(Ptr<Packet> packet, double rxPowerDbm,
			WifiTxVector txVector, WifiPreamble preamble, ns3::Vector sender);
	void StartReceivePacket(Ptr<Packet> packet, double rxPowerDbm,
	...
	virtual void SendPacket(Ptr<const Packet> packet, WifiTxVector txvector,
...
private:
	...
	std::map<uint64_t, RxBeginEnd> m_timeRx;
