#ifndef CGAME_INOUT_GREEDY_MERGED_ANOTHER_GREEDY_H
#define CGAME_INOUT_GREEDY_MERGED_ANOTHER_GREEDY_H
#include <fstream>
...
class cgameinoutgreedyMergedAnotherGreedy: public ns3::Object {
public:
	static ns3::TypeId
	GetTypeId(void);
	cgameinoutgreedyMergedAnotherGreedy();
	cgameinoutgreedyMergedAnotherGreedy(double comRangeRsu, double comRangeObu,
