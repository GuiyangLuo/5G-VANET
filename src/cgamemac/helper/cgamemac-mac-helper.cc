...
CgamemacMacHelper::CgamemacMacHelper ()
{
}
...
CgamemacMacHelper
CgamemacMacHelper::Default (void)
{
  CgamemacMacHelper helper;
  helper.SetType("cgamemac::CgamemacMac");
  return helper;
}

void
CgamemacMacHelper::SetType (std::string type,
...
ns3::Ptr<CgamemacMac>
CgamemacMacHelper::Create (void) const
{
  ns3::Ptr<CgamemacMac> mac = m_mac.Create<CgamemacMac> ();
  return mac;
}
