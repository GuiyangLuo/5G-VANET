#include "cgame-inout-greedyMerged.h"
...
NS_LOG_COMPONENT_DEFINE("cgameinoutgreedyMerged");
namespace cgame {

ns3::TypeId cgameinoutgreedyMerged::GetTypeId(void) {
	ns3::TypeId tid =
			ns3::TypeId("cgame::cgameinoutgreedyMerged").SetParent<ns3::Object>().AddConstructor<
					cgame::cgameinoutgreedyMerged>().AddAttribute(
					"m_NeighborNumber",
					...
					ns3::MakeUintegerAccessor(
							&cgameinoutgreedyMerged::m_NeighborNumber),
					ns3::MakeUintegerChecker<uint32_t>());
	return tid;
}
cgameinoutgreedyMerged::cgameinoutgreedyMerged() {
	NS_ASSERT(false);
	setCallbackForReceiveFromMaclayer();

}
cgameinoutgreedyMerged::cgameinoutgreedyMerged(double comRangeRsu,
...
void cgameinoutgreedyMerged::receiveFromMaclayer(
...
void cgameinoutgreedyMerged::printAllTTnew() {
...
void cgameinoutgreedyMerged::printCOnflictgraph() {
...
void cgameinoutgreedyMerged::printDirectedNeighborGraph() {
	uint32_t first = 0, second = 0;
...
void cgameinoutgreedyMerged::printNodeInfor() {
...
void cgameinoutgreedyMerged::SchedulingBegin() {
...
void cgameinoutgreedyMerged::DeleteSameForAllTTnews() {
...
void cgameinoutgreedyMerged::HandlingResults() {
...
int cgameinoutgreedyMerged::BalancedRate(uint32_t sender,
...
void cgameinoutgreedyMerged::GreedyAlgorithm() {
...
void cgameinoutgreedyMerged::getWeightForEachTTnew() {
...
void cgameinoutgreedyMerged::CheckForConfilct() {
...
bool cgameinoutgreedyMerged::isEqualForTwoSet(std::set<uint8_t> set1,
...
bool cgameinoutgreedyMerged::isEqualForTwoSet32(std::set<uint32_t> set1,
...
void cgameinoutgreedyMerged::GetAllTTnews() {
...
void cgameinoutgreedyMerged::GetAllTTnewsReduced() {
	std::map<uint32_t, ns3::Ptr<cgame::GraphUpLoad> >::iterator sender;
...
void cgameinoutgreedyMerged::GetTTnewsForCertainReceivers(uint32_t sender,
...
void cgameinoutgreedyMerged::alpha2TimesReducedForItems(uint32_t i,
...
void cgameinoutgreedyMerged::alpha2TimesReducedForReceivers(uint32_t i,
...
std::set<uint8_t> cgameinoutgreedyMerged::OrforTwoSet(std::set<uint8_t> alpha,
...
void cgameinoutgreedyMerged::GetTTnewsForCertainNode(uint32_t senderId,
...
void cgameinoutgreedyMerged::alpha2Times(uint32_t i,
		std::vector<uint8_t> Temp) {
	std::vector<uint8_t> reTemp;
	reTemp = Temp;
	if (i == m_alpha.size()) {
...
std::set<uint8_t> cgameinoutgreedyMerged::ConvertVectorToSet(
...
void cgameinoutgreedyMerged::SelectOnExponentTTnews(uint32_t senderId,
		std::set<uint8_t> alpha, std::vector<uint32_t> allneighbors,
		std::set<uint32_t> allneigborsOfChannel) {
...
int cgameinoutgreedyMerged::PrintNumberOfOriginsTTnew(uint32_t senderId,
		std::set<uint8_t> alpha, std::vector<uint32_t> allneighbors,
		std::set<uint32_t> allneigborsOfChannel) {
	int totalNumber = 0;
...
void cgameinoutgreedyMerged::GetAllPossibleTransmissionSet(uint32_t senderId,
		std::set<uint8_t> alpha, std::vector<uint32_t> allneighbors,
		std::set<uint32_t> allneigborsOfChannel) {
	NS_ASSERT(1 == 0);
	m_alpha.clear();
...
std::set<uint32_t> cgameinoutgreedyMerged::VectorToSet(uint32_t senderId,
...
void cgameinoutgreedyMerged::GetChannelInfor() {
	std::map<uint32_t, ns3::Ptr<cgame::GraphUpLoad> >::iterator sender,
			receiver;
...
///
std::set<uint8_t> cgameinoutgreedyMerged::AndforTwoSet(std::set<uint8_t> alpha,
		std::set<uint8_t> beta) {
	std::set<uint8_t> results;
	results.clear();
	std::set<uint8_t>::iterator it1;
...
void cgameinoutgreedyMerged::setCallbackForReceiveFromMaclayer() {
	...
	for (ns3::NodeList::Iterator i = ns3::NodeList::Begin();
		...
		(*i)->GetDevice(0)->GetObject<cgamemac::CgamemacNetDevice>()->SetGraphUpLoadCallback(
				ns3::MakeCallback(&cgameinoutgreedyMerged::receiveFromMaclayer,
						this));

	}

}
void cgameinoutgreedyMerged::SendToMaclayer(
...
void cgameinoutgreedyMerged::sendAdToMaclayer(
...
void cgameinoutgreedyMerged::ClearForPerScheduling() {
