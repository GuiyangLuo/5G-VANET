#ifndef CGAME_INOUT_GREEDY_IMPROVED_H
#define CGAME_INOUT_GREEDY_IMPROVED_H
#include <fstream>
...
class cgameinoutgreedyImproved: public ns3::Object {
public:
	static ns3::TypeId
	GetTypeId(void);
	cgameinoutgreedyImproved();
	cgameinoutgreedyImproved(double comRangeRsu, double comRangeObu,
