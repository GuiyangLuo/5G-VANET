#ifndef CGAME_INOUT_GREEDY_MERGED_H
#define CGAME_INOUT_GREEDY_MERGED_H
#include <fstream>
...
class cgameinoutgreedyMerged: public ns3::Object {
public:
	static ns3::TypeId
	GetTypeId(void);
	cgameinoutgreedyMerged();
	cgameinoutgreedyMerged(double comRangeRsu, double comRangeObu,
